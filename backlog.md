...
- [vat-z4q] [in-progress] [by:jared] [agent-ready] `vat done <id>` command (see ./items/vat-z4q.md)
- [vat-m2k] [agent-ready] [blocked-by:vat-z4q] Consolidate duplicated command-module code across vat start/block/unblock/done — shared single-bullet-replace serialize helper, shared test helpers, backlog-path constant (see ./items/vat-m2k.md)
