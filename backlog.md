...
- [vat-f7v] [in-progress] [by:jared] [agent-ready] Snapshot tests for the other commands (see ./items/vat-f7v.md)
- [vat-j5z] [in-progress] [by:jared] [agent-ready] Release packaging (see ./items/vat-j5z.md)
